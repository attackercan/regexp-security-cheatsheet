...
|4|  Regexp should not be vulnerable to ReDoS (Chapter 5.2). | Find various evil patterns. [OWASP ReDoS](https://www.owasp.org/index.php/Regular_expression_Denial_of_Service_-_ReDoS) Example: `grep -P '\((.*?)\)[^\\]?[\+\*]'` Generate evil string using e.g. “SDL Regex Fuzzer” |
